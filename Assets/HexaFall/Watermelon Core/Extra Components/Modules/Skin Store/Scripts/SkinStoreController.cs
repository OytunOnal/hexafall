...
namespace HexFall
{
    public class SkinStoreController : MonoBehaviour
    {
        ...
        public static void OpenStore()
        {
            ...
            UIController.instance.ShowPage<UISkinStore>();
        }
        ...
        {
            return products[GetTab(0)].GetRandomItem<SkinData>(); 
        }

        public static SkinData GetRandomHat()
        {
            return products[GetTab(1)].GetRandomItem<SkinData>();
        }
